...
using static StockDistri.MVVM.View.ParametreGeneraux;
...
namespace StockDistri.MVVM.View
{
    public partial class UserLogIn : Page
    {
        ...
        public UserLogIn(NavigationService navigationService)
        {
            ...
            // Pass the NavigationService instance to ParametreGeneraux constructor
            ParametreGeneraux parametreGenerauxInstance = new ParametreGeneraux(navigationService);
        }

        public string Username { get; internal set; }

        private bool AuthenticateUser(string username, string enteredPassword, ParametreGeneraux parametreGeneraux)
        {
            ...
            if (result != null && result.Rows.Count > 0)
            {
                ...
                string enteredHashedPassword = parametreGeneraux.HashPassword(enteredPassword);
        ...
        {
            // Assuming you have a reference to ParametreGeneraux instance, replace 'parametreGenerauxInstance' with the actual instance
            ParametreGeneraux parametreGenerauxInstance = new ParametreGeneraux(navigationService);
            ...
            // Hash the entered password using the same method used during registration
            string enteredHashedPassword = parametreGenerauxInstance.HashPassword(enteredPassword);

            if (AuthenticateUser(username, enteredPassword, parametreGenerauxInstance))
            {
